    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="content">
                ...
                <%
                String name = GetTeacherName.name;
                Connection con = connectDB.dbCon();
                PreparedStatement ps = con.prepareStatement("select * from faculty_courses");
               ...
               <% }
                ...
                %>
                 ...
                 <!-- Add this button/link to trigger PDF export -->
					<div class="export-buttons">
					    <form action="ExportPDFServlet" method="get">
					        <button type="submit">Export to PDF</button>
					    </form>
					</div>
                <div id="dyna mic-content"></div>
            </div>
            <footer class="footer">
